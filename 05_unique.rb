...
# They then expanded to Brisbane, and while Brisbane began with mostly the same product sku list 
#(some items they stopped stocking because they didn’t sell so well), they also had some extras and ended up with the following list:
